...
$nama_anak = $_POST['no_pendaftaran'];
	...
	$simpan = mysql_query("INSERT INTO pendaftaran VALUES('$no_pendaftaran','$nama_anak','$tempat_lahir','$tanggal_lahir','$jenis_kelamin','$anak_ke','$jumlah_saudara','$alamat','$nama_ayah','$nama_ibu','$alamat_orang_tua')");
	if($simpan){
		echo"<script>
