...
$pdf-> Cell  (50,5,'Laporan DATA Guru','0','1','L',false); 
$pdf-> Ln(3);
...
$pdf-> Cell(25,6,'No Tlp',1,0,'c');
$pdf-> Ln(2);
$no = 0;
$sql = mysql_query("select *from guru order by  id_guru asc");
while ($data =mysql_fetch_array($sql)){
	...
	$pdf-> Cell (10,4,$data['id_guru'],1,0,'L');
	$pdf-> Cell (30,4,$data['nama'],1,0,'L');
	...
	$pdf-> Cell (25,4,$data['no_tlp'],1,0,'L');
